      ...
      <div class="w-full mb-2 flex items-center justify-start">
         <span>
            <RouterLink to="/authentication/login">
               <IconVoltar class="text-slate-800"
            /></RouterLink>
         </span>
      </div>
      <div
      ...
      >
         ...
         <div class="grid grid-cols-6 gap-x-2 gap-y-6">
            ...
            <div class="col-span-6 md:col-span-3 h-20 space-y-1">
               ...
               />
               <p
                  v-if="state.input.name.valid.length > 0"
                  class="msg-campo-invalido"
               >
                  {{ state.input.name.valid }}
               </p>
            </div>
            <!-- Último nome -->
            <div class="col-span-6 md:col-span-3 h-20 space-y-1">
               ...
               />
               <p
                  v-if="state.input.lastname.valid.length > 0"
                  class="msg-campo-invalido"
               >
                  {{ state.input.lastname.valid }}
               </p>
            </div>
            <!-- email -->
            <div class="col-span-6 h-20 space-y-1">
               ...
               />
               <p
                  v-if="state.input.email.valid.length > 0"
                  class="msg-campo-invalido"
               >
                  {{ state.input.email.valid }}
               </p>
            </div>
            <!-- cpf -->
            <div class="col-span-6 md:col-span-3 h-20 space-y-1">
               ...
               />
               <p
                  v-if="state.input.cpf.valid.length > 0"
                  class="msg-campo-invalido"
               >
                  {{ state.input.cpf.valid }}
               </p>
            </div>
            <!-- aniversario -->
            <div class="col-span-6 md:col-span-3 h-20 space-y-1">
               ...
               />
               <p
                  v-if="state.input.birthday.valid.length > 0"
                  class="msg-campo-invalido"
               >
                  {{ state.input.birthday.valid }}
               </p>
            </div>
            <!-- senha -->
            <div class="col-span-6 md:col-span-3 h-20 space-y-1">
               ...
               />
               <p
                  v-if="state.input.password.valid.length > 0"
                  class="msg-campo-invalido"
               >
                  {{ state.input.password.valid }}
               </p>
            </div>
            <!-- confirmar senha -->
            <div class="col-span-6 md:col-span-3 h-20 space-y-1">
               ...
               />
               <p
                  v-if="state.input.confirmPassword.valid.length > 0"
                  class="msg-campo-invalido"
               >
                  {{ state.input.confirmPassword.valid }}
               </p>
            </div>
            <div
               class="col-span-6 mt-5 flex flex-col md:flex-row md:items-center md:justify-center space-y-4 md:space-y-0 md:space-x-5"
            >
               <button @click="onClickedCancelar()" class="btn-cancelar">
                  Cancelar
               </button>
               <button @click="onClickedSalvar()" class="btn-salvar">
                  Salvar
               </button>
            </div>
         </div>
